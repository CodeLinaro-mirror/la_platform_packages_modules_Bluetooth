...
public final class BluetoothManager {
    ...
    public BluetoothGattServer openGattServer(
        ...
        return (openGattServer(context, ADAPTER_DEFAULT, callback));
    }
    ...
    @Nullable public BluetoothGattServer openGattServer(
        ...
        return (openGattServer(context, adapterIndex, callback, BluetoothDevice.TRANSPORT_AUTO));
    }
    ...
    @SuppressLint("UnflaggedApi")
    @Nullable public BluetoothGattServer openGattServer(
            Context context, int adapterIndex, BluetoothGattServerCallback callback, boolean eattSupport) {
    ...
    @SuppressLint("UnflaggedApi")
    @Nullable public BluetoothGattServer openGattServer(
            Context context, int adapterIndex, BluetoothGattServerCallback callback, int transport) {
