...
static void sendMediaUpdateExtNative(JNIEnv* env, jobject /* object */,
  ...
  mServiceCallbacks->SendMediaUpdateExt(bdaddr.value(), metadata == JNI_TRUE, state == JNI_TRUE,
                                     queue == JNI_TRUE);
}
...
static void sendMediaKeyEvent(const RawAddress& address, int key, KeyState state) {
  ...
  sCallbackEnv->CallVoidMethod(mJavaInterface, method_sendMediaKeyEventExt, j_bdaddr, key,
...
int register_com_android_bluetooth_avrcp_target(JNIEnv* env) {
  ...
  const JNIJavaMethod javaMethods[] = {
          ...
          {"getCurrentSongInfoExt", "(Ljava/lang/String;)Lcom/android/bluetooth/audio_util/Metadata;",
           &method_getCurrentSongInfoExt},
          ...
          {"sendMediaKeyEventExt", "(Ljava/lang/String;IZ)V", &method_sendMediaKeyEventExt},
          {"getPlayStatusExt", "(Ljava/lang/String;)Lcom/android/bluetooth/audio_util/PlayStatus;",
           &method_getPlaybackStatusExt},
          {"getCurrentMediaId", "()Ljava/lang/String;", &method_getCurrentMediaId},
          {"getCurrentMediaIdExt", "(Ljava/lang/String;)Ljava/lang/String;", &method_getCurrentMediaIdExt},
          {"getNowPlayingList", "()Ljava/util/List;", &method_getNowPlayingList},
          {"getNowPlayingListExt", "(Ljava/lang/String;)Ljava/util/List;", &method_getNowPlayingListExt},
          ...
          {"setVolumeExt", "(Ljava/lang/String;I)V", &method_setVolumeExt},
