...
interface IBluetoothLeBroadcastAssistant {
    ...
    @JavaPassthrough(annotation="@android.annotation.RequiresPermission(allOf={android.Manifest.permission.BLUETOOTH_CONNECT,android.Manifest.permission.BLUETOOTH_PRIVILEGED})")
    void setAchatAttributes(int devId, in byte[] name, in AttributionSource source);
    @JavaPassthrough(annotation="@android.annotation.RequiresPermission(allOf={android.Manifest.permission.BLUETOOTH_CONNECT,android.Manifest.permission.BLUETOOTH_PRIVILEGED})")
    BluetoothLeBroadcastMetadata getSourceMetadata(in BluetoothDevice sink, int sourceId, in AttributionSource source);
}
