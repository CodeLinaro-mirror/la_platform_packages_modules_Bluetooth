...
/**
 * This implements a GetLinkedThumbnail request, allowing a user to retrieve
 * an image from the remote device with a specified format, encoding, etc.
 */
public class RequestGetLinkedThumbnail extends BipRequest {
    // Expected inputs
    ...
    public RequestGetLinkedThumbnail(String imageHandle) {
        mHeaderSet = new HeaderSet();
        mResponseCode = -1;

        mImageHandle = imageHandle;

        debug("GetLinkedThumbnail - handle: " + mImageHandle);
    ...
    @Override
    public int getType() {
        return TYPE_GET_LINKED_THUMBNAIL;
    }
    ...
    protected void readResponse(InputStream stream) throws IOException {
        ...
        debug("Response GetLinkedThumbnail - handle:" + mImageHandle + ", image: " + mImage);
    }
