...
// Params: uint16_t conn_id, std::vector<tGATT_VALUE> notif_vector
// Return: tGATT_STATUS
struct GATTS_HandleMultipleValueNotification {
  static tGATT_STATUS return_value;
  std::function<tGATT_STATUS(uint16_t conn_id, std::vector<tGATT_VALUE> notif_vector)>
      body{[](uint16_t /* conn_id */, std::vector<tGATT_VALUE> /* notif_vector */) {
        return return_value;
      }};
