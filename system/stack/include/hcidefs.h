...
/* HDT COMMANDS*/
#define HCI_REFRESH_ENCRYPTION_KEY_V2 (0x03E5 | HCI_GRP_HDT_CMDS)
#define HCI_BLE_START_ENC_V2 (0x03E6 | HCI_GRP_HDT_CMDS)
#define HCI_LE_SET_HDT_DEFAULT_PARAMETERS (0x03F7 | HCI_GRP_HDT_CMDS)
#define HCI_BLE_READ_MAXIMUM_DATA_LENGTH_V2 (0x03E7 | HCI_GRP_HDT_CMDS)
#define HCI_LE_SET_CIG_PARAMS_V2 (0x0076 | HCI_GRP_HDT_CMDS)
#define HCI_LE_SET_CIG_PARAMS_V3 (0x03FB | HCI_GRP_HDT_CMDS)
#define HCI_LE_SET_CIG_PARAMS_V3_TEST (0x03FD | HCI_GRP_HDT_CMDS)
#define HCI_LE_CREATE_BIG_V2 (0x03F9 | HCI_GRP_HDT_CMDS)
#define HCI_LE_CREATE_BIG_V2_TEST (0x03F8 | HCI_GRP_HDT_CMDS)
#define HCI_BLE_SET_DATA_LENGTH_V2 (0x03F4 | HCI_GRP_HDT_CMDS)
#define HCI_BLE_READ_ENC_KEY_SCHED_DEBUG_MODE (0x03F3 | HCI_GRP_HDT_CMDS)
...
#define HCI_BLE_CIS_EST_EVT_V3 0xFA
